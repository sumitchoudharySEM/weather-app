...
function App() {
  ...
  const getWeatherDetail = async (location) => {
    ...
    const URL = `https://api.openweathermap.org/data/2.5/forecast?${method_result}&appid=4ebc1805db80e6affcefa2f6a2504198&units=metric&cnt=5&exclude=hourly,minutely`;
    console.log(URL);
